...
\begin{frame}{Abstract Language}
  ...
  \begin{itemize}
    ...
    \begin{align*}
      C ::= \texttt{skip} \mid \texttt{p()} \mid \texttt{acq(l);C;rel(l)} \mid \texttt{C;C} \\ \mid \texttt{if(*) then C else C} \mid \texttt{while(*) do C} \\
    \end{align*}
...
\begin{frame}{Semantics}
  \begin{itemize}
    \item Each thread has a \textbf{lock state} which maps locks to acquisition counts.
